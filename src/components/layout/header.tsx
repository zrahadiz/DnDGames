        ...
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between md:grid md:grid-cols-3">
          ...
          <div className="flex justify-end items-center">
            {!user ? (
              <Link href="/login">
                <button
                  className="px-5 py-2 rounded-lg text-sm font-medium transition-all duration-200 hover:-translate-y-0.5 cursor-pointer"
                  style={{
                    fontFamily: "'Cinzel', serif",
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="flex items-center gap-2 rounded-full transition-all duration-200 hover:brightness-110 cursor-pointer"
                ...
                >
                  {user.image ? (
                    <img
                      ...
                      className="w-9 h-9 rounded-full object-cover border border-[rgba(200,169,110,0.45)]"
                    />
                  ) : (
                    <div
                      className="w-9 h-9 rounded-full flex items-center justify-center text-xs font-bold border border-[rgba(200,169,110,0.45)]"
                      style={{
                        fontFamily: "'Cinzel', serif",
                        background: "linear-gradient(135deg, #2a1f0a, #1e1808)",
                        color: "#d4b87a",
                  ...
                  <span
                    className={`text-xs text-[#8a6f3e] transition-transform duration-200 ${
                ...
                {profileOpen && (
                  <div
                    ...
                    style={{
                      ...
                      boxShadow:
                        "0 16px 40px rgba(0,0,0,0.45), 0 0 20px rgba(200,169,110,0.06)",
                    }}
                  >
                    {/* User Information */}
                    ...
                    <div className="h-px bg-[rgba(200,169,110,0.12)]" />

                    {/* Logout */}
                    <button
                      onClick={handleLogout}
                      className="w-full px-4 py-3 text-left text-sm text-[#f87171] transition hover:bg-[rgba(239,68,68,0.08)] cursor-pointer"
                    >
                      Logout
                    </button>
                  </div>
