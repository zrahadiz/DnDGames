...
const Hero = () => (
  <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-6 py-20 overflow-hidden">
    ...
    >
      Gather your party. Face dungeons crafted by an ancient intelligence. Build
      worlds others will explore for years to come.
    </p>
          ...
          {features.map((f, i) => (
            <div
              ...
              style={{
                ...
                boxShadow: hovered === i ? `0 0 30px ${f.accent}18` : "none",
...
const FinalCTA = () => (
  <section className="relative pb-20 px-6 text-center overflow-hidden">
    ...
    <div className="max-w-2xl mx-auto">
      ...
      >
        "Not all who wander are lost — but all who enter Tavern Gate find what
        they seek."
      </p>
      <OrnamentalDivider className="max-w-xs mx-auto mb-10" />
